...
type
    ...
    kinc_g4_render_target_t*{.importc:"kinc_g4_render_target_t", header:hhkRTarget.} = object
        width: cint
        height: cint
        texWidth: cint
        texHeight: cint
...
proc kinc_g4_render_target_init*(renderTarget: var kinc_g4_render_target_t, width: cint, height: cint, depthBufferBits: cint, 
...
proc kinc_g4_render_target_destroy*(renderTarget: var kinc_g4_render_target_t)
    {.header:hhkRTarget.}
